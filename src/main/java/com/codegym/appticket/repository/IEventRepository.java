...
public interface IEventRepository extends JpaRepository<Event, Long> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    java.util.List<Object[]> sumRevenueAndTickets(@Param("eventId") Long eventId,
    ...
    @Query("""
            ...
            """)
    List<com.codegym.appticket.dto.event.BookedTicketDTO> findBookedTicketsByEventAndOccurrence(
            @Param("eventId") Long eventId, @Param("occurrenceId") Long occurrenceId);
